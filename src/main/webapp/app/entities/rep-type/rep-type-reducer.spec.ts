...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_REPTYPE_LIST actions', async () => {
    ...
    it('dispatches SEARCH_REPTYPES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_REPTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_REPTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_REPTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_REPTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_REPTYPE actions', async () => {
      const expectedActions = [
        {
