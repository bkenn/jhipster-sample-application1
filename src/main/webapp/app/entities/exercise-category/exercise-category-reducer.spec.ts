...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './exercise-category.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_EXERCISECATEGORY_LIST actions', async () => {
    ...
    it('dispatches SEARCH_EXERCISECATEGORIES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_EXERCISECATEGORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_EXERCISECATEGORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_EXERCISECATEGORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_EXERCISECATEGORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_EXERCISECATEGORY actions', async () => {
      const expectedActions = [
        {
