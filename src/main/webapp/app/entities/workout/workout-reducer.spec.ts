...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_WORKOUT_LIST actions', async () => {
    ...
    it('dispatches SEARCH_WORKOUTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_WORKOUT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_WORKOUT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_WORKOUT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_WORKOUT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_WORKOUT actions', async () => {
      const expectedActions = [
        {
