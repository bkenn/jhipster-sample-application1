...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './workout-routine-group.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_WORKOUTROUTINEGROUP_LIST actions', async () => {
    ...
    it('dispatches SEARCH_WORKOUTROUTINEGROUPS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_WORKOUTROUTINEGROUP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_WORKOUTROUTINEGROUP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_WORKOUTROUTINEGROUP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_WORKOUTROUTINEGROUP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_WORKOUTROUTINEGROUP actions', async () => {
      const expectedActions = [
        {
