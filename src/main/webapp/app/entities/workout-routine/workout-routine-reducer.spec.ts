...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_WORKOUTROUTINE_LIST actions', async () => {
    ...
    it('dispatches SEARCH_WORKOUTROUTINES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_WORKOUTROUTINE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_WORKOUTROUTINE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_WORKOUTROUTINE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_WORKOUTROUTINE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_WORKOUTROUTINE actions', async () => {
      const expectedActions = [
        {
