...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './workout-routine-exercise.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_WORKOUTROUTINEEXERCISE_LIST actions', async () => {
    ...
    it('dispatches SEARCH_WORKOUTROUTINEEXERCISES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_WORKOUTROUTINEEXERCISE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_WORKOUTROUTINEEXERCISE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_WORKOUTROUTINEEXERCISE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_WORKOUTROUTINEEXERCISE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_WORKOUTROUTINEEXERCISE actions', async () => {
      const expectedActions = [
        {
