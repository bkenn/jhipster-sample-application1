...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PROGRESSPHOTO_LIST actions', async () => {
    ...
    it('dispatches SEARCH_PROGRESSPHOTOS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_PROGRESSPHOTO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PROGRESSPHOTO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PROGRESSPHOTO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PROGRESSPHOTO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PROGRESSPHOTO actions', async () => {
      const expectedActions = [
        {
