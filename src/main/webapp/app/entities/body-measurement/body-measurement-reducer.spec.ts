...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BODYMEASUREMENT_LIST actions', async () => {
    ...
    it('dispatches SEARCH_BODYMEASUREMENTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_BODYMEASUREMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_BODYMEASUREMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_BODYMEASUREMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_BODYMEASUREMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_BODYMEASUREMENT actions', async () => {
      const expectedActions = [
        {
