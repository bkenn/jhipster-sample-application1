...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MEASUREMENTTYPE_LIST actions', async () => {
    ...
    it('dispatches SEARCH_MEASUREMENTTYPES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_MEASUREMENTTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_MEASUREMENTTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_MEASUREMENTTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_MEASUREMENTTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_MEASUREMENTTYPE actions', async () => {
      const expectedActions = [
        {
