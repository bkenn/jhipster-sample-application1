...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './workout-exercise-set.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_WORKOUTEXERCISESET_LIST actions', async () => {
    ...
    it('dispatches SEARCH_WORKOUTEXERCISESETS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_WORKOUTEXERCISESET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_WORKOUTEXERCISESET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_WORKOUTEXERCISESET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_WORKOUTEXERCISESET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_WORKOUTEXERCISESET actions', async () => {
      const expectedActions = [
        {
