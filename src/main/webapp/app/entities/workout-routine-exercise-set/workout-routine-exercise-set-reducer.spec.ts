...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './workout-routine-exercise-set.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_WORKOUTROUTINEEXERCISESET_LIST actions', async () => {
    ...
    it('dispatches SEARCH_WORKOUTROUTINEEXERCISESETS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_WORKOUTROUTINEEXERCISESET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_WORKOUTROUTINEEXERCISESET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_WORKOUTROUTINEEXERCISESET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_WORKOUTROUTINEEXERCISESET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_WORKOUTROUTINEEXERCISESET actions', async () => {
      const expectedActions = [
        {
