...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MUSCLE_LIST actions', async () => {
    ...
    it('dispatches SEARCH_MUSCLES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_MUSCLE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_MUSCLE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_MUSCLE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_MUSCLE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_MUSCLE actions', async () => {
      const expectedActions = [
        {
