...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_EXERCISEIMAGE_LIST actions', async () => {
    ...
    it('dispatches SEARCH_EXERCISEIMAGES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_EXERCISEIMAGE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_EXERCISEIMAGE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_EXERCISEIMAGE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_EXERCISEIMAGE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_EXERCISEIMAGE actions', async () => {
      const expectedActions = [
        {
