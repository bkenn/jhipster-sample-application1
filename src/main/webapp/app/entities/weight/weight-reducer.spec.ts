...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_WEIGHT_LIST actions', async () => {
    ...
    it('dispatches FETCH_WEIGHT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_WEIGHT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_WEIGHT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_WEIGHT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_WEIGHT actions', async () => {
      const expectedActions = [
        {
