...
export const WeightDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterSampleApplication1App.weight.delete.question">
        <Translate contentKey="jhipsterSampleApplication1App.weight.delete.question" interpolate={{ id: weightEntity.id }}>
