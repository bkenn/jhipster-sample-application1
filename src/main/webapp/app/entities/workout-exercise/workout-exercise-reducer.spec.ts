...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_WORKOUTEXERCISE_LIST actions', async () => {
    ...
    it('dispatches SEARCH_WORKOUTEXERCISES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_WORKOUTEXERCISE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_WORKOUTEXERCISE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_WORKOUTEXERCISE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_WORKOUTEXERCISE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_WORKOUTEXERCISE actions', async () => {
      const expectedActions = [
        {
